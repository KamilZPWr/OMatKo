...
import com.pwr.knif.omatko.dummy.DummyContent
...
class PersonContactFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            ...
            view.adapter = PersonContactRecyclerViewAdapter(DummyContent.ITEMS, mListener)
        }
        return view
    }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int): PersonContactFragment {
            val fragment = PersonContactFragment()
            val args = Bundle()
